...
public class DbSeeder implements CommandLineRunner {
	...
	public void run(final String... args) throws Exception {
		...
		this.produitDao.save(new Produit("Chaise pour s'assoir", "Chaise rare avec non pas 1 ni 2 mais 3 pieds",
		...
		this.produitDao.save(new Produit("Coq of steel, le superman des volailles", "Ne passe pas au four",
				"https://s3.eu-west-3.amazonaws.com/oc-images-cours/coq.jpg", 620.0));
		this.produitDao.save(
				new Produit("Flacon à frotter avec un génie dedans", "Vous donne droit à l'équivalent de 3/0 voeux",
						"https://s3.eu-west-3.amazonaws.com/oc-images-cours/flacon.jpg", 1200.0));
		this.produitDao.save(
				new Produit("Horloge quantique", "Donne l'heure, les minutes et même les secondes. Ne fait pas de café",
